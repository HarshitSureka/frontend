...
const AddChapters = (props) => {
    ...
    return ( 
      ...
      className="mb-3"
    >
      <Tab eventKey="skill" title="Add Skill">
        <Form style={{width:"80%", marginLeft:"10%", marginTop:"3%"}}>
            ...
            <br></br>
            <Button  onClick={submitForSkill}>Submit</Button>
        ...
        <Form style={{width:"80%", marginLeft:"10%", marginTop:"3%"}}>
            ...
            <Form.Group >
                <Form.Label>Enter Corresponding Skill</Form.Label><br></br>
                    <Form.Select value={correspondingSkillForCategory} onChange={handleCorrespondingSkillForCategoryChange}>
                        {skills.map((option) => (
                            ...
                            <div className="row mb-3">
                                <div class="form-group col-md-4">
                                    ...
                                    <Form.Group >
                                        ...
                                        onChange={ (e) => handleCategoryInput(e,i) }/>
                                    </Form.Group>
                                </div>
                                <div class="form-group col-md-2 mt-4">
                                {
                                    categoriesList.length!==1 &&
                                    <button  className="btn btn-danger mx-1" onClick={()=> handleCategoryRemove(i)}>Remove</button>
                                }
                                { categoriesList.length-1===i &&
                                    <button  className="btn btn-success" onClick={ handleCategoryAddNew}>Add More</button>
                                }
                                </div>
                            </div>
                        );
            ...
            <Button  onClick={submitForCategories}>Submit</Button>
      ...
      <Tab eventKey="subCategories" title="Add Sub Categories">
        ...
        <h1>Add Sub Categories</h1>
            ...
            <Form.Group >
                <Form.Label>Enter Corresponding Skill</Form.Label><br></br>
                    <Form.Select value={correspondingSkillForSubCategory} onChange={handleCorrespondingSkillForSubCategoryChange}>
                        {skills.map((option) => (
                        <option key={option._id} value={option.skill}>{option.skill.split("_").join(" ")}</option>
                        ))}
                    </Form.Select>
                            ...
                            
            {
                ...
                <Form.Group >
                    ...
                    <Form.Select value={correspondingCategoryForSubCategory} onChange={handleCorrespondingCategoryForSubCategoryChange}>
                    ...
                    <div className="row mb-3">
                        <div class="form-group col-md-4">
                            ...
                            <Form.Group >
                                ...
                                onChange={ (e) => handleSubCategoryInput(e,i) }/>
                            </Form.Group>
                        </div>
                        <div class="form-group col-md-2 mt-4">
                        {
                            subCategoriesList.length!==1 &&
                            <button  className="btn btn-danger mx-1" onClick={()=> handleSubCategoryRemove(i)}>Remove</button>
                        }
                        { subCategoriesList.length-1===i &&
                            <button  className="btn btn-success" onClick={ handleSubCategoryAddNew}>Add More</button>
                        }
                        </div>
                    </div>
                    );
            ...
            <Button  onClick={submitForSubCategories}>Submit</Button>
        </Form>
      </Tab>
    </Tabs>
            </Col>
